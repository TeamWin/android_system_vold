...
bool fscrypt_mount_metadata_encrypted(const std::string& blk_device, const std::string& mount_point,
    ...
    if (version == 1) {
        ...
        android::base::SetProperty("ro.crypto.volume.metadata.method","dm-default-key");
        android::base::SetProperty("ro.crypto.dm_default_key.options_format.version","2");
        android::base::SetProperty("ro.crypto.volume.options","::v2");
